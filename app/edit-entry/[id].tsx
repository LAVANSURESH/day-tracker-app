...
import { MoodType, JournalEntry } from "@/shared/types";
    ...
    <ScreenContainer className="flex-1 bg-background">
      ...
      >
        ...
        <View className="px-6 py-4 border-b border-border">
          <Text className="text-2xl font-bold text-foreground">Edit Entry</Text>
          ...
          <View className="gap-3 pb-6">
            ...
            >
              {saving ? (
                ...
                <Text className="text-background font-semibold text-base">Save Changes</Text>
              )}
            </Pressable>
